  ...
  <Layout>
    ...
    <div style={{ background: 'white' }}>
      <div className="container" style={{ position: 'relative', zIndex: 99 }}>
        ...
        <p className="mb-4">
          React Tiny Grid works out of the box, so all you have to do is wrap a <code>Column</code> component with a <code>Row</code> component. The magic just happens!
        </p>
        <div
          style={{
            background: '#f7f7f7cc',
